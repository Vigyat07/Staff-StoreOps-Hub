...
const mockStores = [
    ...
    },
    {
        id: 'store-2',
        name: 'Belc Suburbia',
        location: '456 Oak Ave, Smallville',
        manager: 'emp-5',
        employeeCount: 12
    }
];
const mockTasks = [
    {
        ...
        description: 'Perform a full inventory count of aisle 5.',
        assignedTo: 'emp-4',
        storeId: 'store-1',
        deadline: '2024-07-30',
        status: 'In Progress'
    },
    {
        ...
        description: 'Finalize and submit the sales report for the third quarter.',
        assignedTo: 'emp-2',
        storeId: 'store-1',
        deadline: '2024-08-05',
        status: 'To-Do'
    ...
    {
        id: 'task-3',
        title: 'Clean the Breakroom Fridge',
        description: 'The fridge needs a thorough cleaning. Remove all old food.',
        assignedTo: 'emp-3',
        storeId: 'store-1',
        deadline: '2024-07-25',
        status: 'Overdue'
    ...
    {
        id: 'task-4',
        title: 'Restock Produce Section',
        description: 'Restock all fresh vegetables and fruits.',
        assignedTo: 'emp-4',
        storeId: 'store-2',
        deadline: '2024-07-28',
        status: 'Done'
    },
    {
        ...
        description: 'Prepare the shift schedule for the next two weeks.',
        assignedTo: 'emp-5',
        storeId: 'store-2',
        deadline: '2024-07-29',
        status: 'In Progress'
    ...
    {
        id: 'task-6',
        title: 'Update Promotional Displays',
        description: 'Change displays to reflect the new "Summer Sale" promotion.',
        assignedTo: 'emp-6',
        storeId: 'store-1',
        deadline: '2024-08-01',
        status: 'To-Do'
    },
    {
        ...
        description: 'Run maintenance scripts on the main server.',
        assignedTo: 'emp-1',
        storeId: 'store-1',
        deadline: '2024-07-31',
        status: 'To-Do'
...
const mockUsers = {
    ...
    'manager@belc.com': {
        ...
        user: {
            id: 'user-2',
            name: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockEmployees"].find((e)=>e.id === 'emp-2')?.name || 'Store Manager',
            email: 'manager@belc.com',
            role: 'store_manager',
            storeId: 'store-1'
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bad1e48._.js.map